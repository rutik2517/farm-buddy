...
for x in myresult :
    ...
    <tr>
                                                ...
                                                <td><a href="ProductDelete.py?id={x['id']}"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                <a href="ProductEdit.py?id={x['id']}"><button>Edit</button></a>
                                                </td>                                            
                                                <td> {x['id']}</td>
                                                <td> {x['ProductName']} </td>
                                                <td> {x['Email']} </td>
                                                <td> <img src="Product/{x['id']}/{x['Photo']}" width="100px" height="100px"/> </td>
